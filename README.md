# Currency [![Build Status](https://travis-ci.org/billthefarmer/currency.svg?branch=master)](https://travis-ci.org/billthefarmer/currency) [![F-Droid](fdroid.png)](https://f-droid.org/repository/browse/?fdid=org.billthefarmer.currency)
